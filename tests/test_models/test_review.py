#!/usr/bin/python3
"""
Unittest for Review Class attributes and methods
"""
...
class TestReview(TestCase):
    ...
    def test_save(self):
        ...
        with open("file.json", "r") as file:
            self.assertIn("Review.{}".format(self.inst1.id), file.read())
    ...
    def test_place_id(self):
        self.assertTrue(hasattr(self.inst2, "place_id"))
        self.assertEqual(self.inst2.place_id, "")

    def test_user_id(self):
        self.assertTrue(hasattr(self.inst2, "user_id"))
