#!/usr/bin/python3
"""
Unittest for City Class attributes and methods
"""
...
class TestCity(TestCase):
    ...
    def test_save(self):
        ...
        with open("file.json", "r") as file:
            self.assertIn("City.{}".format(self.inst1.id), file.read())
    ...
    def test_state_id(self):
        self.assertTrue(hasattr(self.inst2, "state_id"))
        self.assertEqual(self.inst2.state_id, "")
